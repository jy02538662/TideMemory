...
This file summarizes the latest validation results for the current open-source prototype.
...
Note: unified multi-vortex results are in an addressable-memory setting where vortex readout centers are known.
...
## Multi-Symbol Topological Probe, alphabet={-2,-1,+1,+2}, N=4
